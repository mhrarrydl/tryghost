...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: {
        pathNot: [
          // @NOTE: Ghost admin does some magic here that this doesn't understand, ignore
    ...
    },
    {
      ...
      from: {
        path: '^(ghost/)',
        pathNot: '\.(spec|test|gulpfile)\.(js|mjs|cjs|ts|ls|coffee|litcoffee|coffee\.md)$'
      },
      to: {
        dependencyTypes: [
          'npm-dev'
...
// generated: dependency-cruiser@13.1.5 on 2023-09-20T11:18:22.836Z
