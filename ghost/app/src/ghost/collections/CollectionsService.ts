...
export class CollectionsService {
    constructor(
        @Inject('CollectionRepository') private collectionsRepository: CollectionRepository,
        @Inject('CollectionPostsRepository') private postsRepository: PostsRepository,
        @Inject('DomainEvents') private DomainEvents: DomainEvents,
        @Inject('CollectionUniqueChecker') private uniqueChecker: RepositoryUniqueChecker,
        @Inject('CollectionSlugService') private slugService: SlugService
    ) {}
